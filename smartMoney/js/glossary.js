let dict = {
    ...
    "Cost of attendance (COA)":"The total amount it will cost you to go to school — usually stated as a yearly figure. COA includes tuition and fees; room and board (or a housing and food allowance); and allowances for books, supplies, transportation, loan fees, and dependent care if applicable. It also includes some miscellaneous and personal expenses.",
    ...
    "Credit Report":"A summary of your credit activity and current credit situation such as loan paying history and the status of your credit accounts. Lenders use these reports to help them decide if they will loan you money and what interest rates they will offer you. Other businesses might use your credit reports to determine whether to offer you insurance; rent a house or apartment to you; or provide you with cable TV, Internet, utility, or cell phone service. If you agree to let an employer look at your credit report, it may also be used to make employment decisions about you.",
    ...
    "Exchange rate":"A number that is used to compare the value of money in two different countries. For example, you would use an exchange rate to figure out how many pesos or euros you could get for one U.S. dollar.",
    "Expected family contribution":"The index number schools use to determine your eligibility for federal financial aid. This number results from the financial information you provide in your Free Application for Federal Student Aid (FAFSA) form. Your EFC index number is reported to you on your Student Aid Report. It is not the amount of money your family will have to pay for college nor is it the amount of federal student aid you will receive. It is a number your school uses to calculate the amount of federal student aid you are eligible to receive.",
    ...
    "Health savings account":"An account at a bank, insurance company, or other financial institution that lets you set aside pre-tax money, sometimes directly from your paycheck, to pay for eligible medical expenses.",
    ...
    "Impulse purchase":"Buying things without having planned for them beforehand. It can cause you to spend more money than you can afford.",
    "Inactivity fee":"A fee charged if you don't use your card for a certain period of time. The length of time that triggers an inactivity fee varies. Not all prepaid cards charge inactivity fees.",
    ...
    "Irregular income":"Inconsistent amounts of money you receive through work or investments; both the schedule and the amount may vary.",
    "Job":"A specific arrangement where you do tasks for an employer.",
    ...
    "Long-term goals":"Goals that can take more than five years to achieve.",
    ...
    "Money order":"A money order can be used instead of a check. You can buy a money order to pay a business or other party.",
    ...
    "Mutual fund":"A company that pools money from many investors and invests the money in securities such as stocks, bonds, and short-term debt. The combined holdings of the mutual fund are known as its portfolio. Investors buy shares in mutual funds. Each share represents an investor's part ownership in the fund and the income it generates.",
    ...
    "Occupation":"Describes a type of work with associated tasks, education and training, typical wages, work settings, and more. Can be a synonym for career.",
    ...
    "Online or mobile bill payment":"A bill-paying method you set up with your bank or credit union. You use online banking to give your bank the merchant or service provider's information, and your bank makes the payment according to the amount and schedule you set up. Online bill paying may or may not also be offered on a bank's or credit union's mobile application.",
    "Open-loop prepaid card":"This type of card has a network logo on it. Examples of networks are Visa, MasterCard, American Express, and Discover. These cards can be used at any location that accepts that card type. Most prepaid cards are open-loop cards.",
    ...
    "Paper check":"A paper order to a bank or credit union to pay someone from a checking account.",
    ...
    "Post-secondary school certificate (non-degree)":"A certificate or credential that an educational institution awards after a student completes formal schooling lasting from a few weeks to two years after high school. A certificate is not a degree.",
    ...
    "Private college or university (nonprofit)":"A higher education institution that is primarily supported by private funds. Includes not-for-profit schools and schools associated with a religious organization.",
    ...
    "Public service announcement (PSA)":"An announcement or message delivered, often on radio or television, for the good of the public.",
    ...
    "Rebate":"A rebate reduces the price of consumer goods. Most rebates require consumers to pay the full cost of an item at the time of purchase, then to send documentation to the manufacturer or retailer to receive a rebate by mail.",
    ...
    "Short-term goals":"Goals that can take a short time, or up to five years, to reach.",
    ...
    "Supply":"How much of a product is available to buy at any given time.",
    "Tariff":"A tax on products imported from foreign countries. This tax can increase the costs of those products, which ultimately can be passed on to consumers as higher prices.",
    ...
    "Transaction fee":"A fee charged every time you use the card for a certain type of transaction. Be sure to ask about fees or read the cardholder agreement associated with your card.",
    ...
    "U.S. savings bond":"An interest-bearing savings security issued by the U.S. government for a set amount of money.",
    ...
    "Volunteer":"To do something helpful for other people without getting paid to do it.",
